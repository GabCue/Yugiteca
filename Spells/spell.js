window.addEventListener("load", async function() {
    ...
    // Filtra las cartas de monstruos que no son Fusion, XYZ, Sincronía, Links ni Magias ni Trampas
    const filteredMonsters = data.data.filter((card) => {
    ...
    function filterCards() {
      const filteredByFilters = filteredMonsters.filter((monster) => {
        ...
        return levelCondition && attributeCondition && raceCondition;
      });
